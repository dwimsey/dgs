...
import java.awt.*;
import java.beans.*;
import DGS.DGSPreviewer.DGSPreviewCanvasLoaderWorker;
...
public class DGSPreviewCanvas extends javax.swing.JPanel implements java.awt.event.ComponentListener {
	...
	public static void printUri(String fileUri, String dgsPackageFile, ProcessingEngine pEngine, NotificationMethods newMethods) {
		...
		//dgsPackageFile;
		if(newMethods == null) {
			newMethods = new DGS.DGSPreviewer.DGSPreviewCanvas.NotificationMethods() {
				@Override
				public void logEvent(int LogLevel, String Message)
				{
				}
		...
		final DGS.DGSPreviewer.DGSPreviewCanvas.NotificationMethods notificationMethods = newMethods;
    ...
    private void initComponents() {
        ...
        renderedCanvas = new DGS.DGSPreviewer.DGSPreviewerPanel();
    ...
    protected DGS.DGSPreviewer.DGSPreviewerPanel renderedCanvas;
