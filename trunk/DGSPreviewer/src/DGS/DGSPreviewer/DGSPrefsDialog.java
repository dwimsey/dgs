...
import DGS.DGSPreviewer.Options;
import DGS.DGSPreviewer.DGSPreviewCanvas.DisplayMode;
...
//			newOpts.setStartupMode(DisplayMode.TIFF);
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(DGS.DGSPreviewer.DGSPreviewerApp.class).getContext().getActionMap(DGSPrefsDialog.class, this);
        buttonOk.setAction(actionMap.get("onOkClicked")); // NOI18N
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(DGS.DGSPreviewer.DGSPreviewerApp.class).getContext().getResourceMap(DGSPrefsDialog.class);
