...
public class Main {
	...
	public static void main(String[] args) {
		...
		DGS.dgs4j.ProcessingEngine.ProcessingEngine pEngine = new DGS.dgs4j.ProcessingEngine.ProcessingEngine();
	...
	private static int processDGSPackage(DGS.dgs4j.ProcessingEngine.ProcessingEngine pEngine,
		...
		if (!vars.isEmpty()) {
			...
			if (dPkg.variables != null && dPkg.variables.length > 0) {
				...
				DGS.dgs4j.DGSVariable nVars[] = new DGS.dgs4j.DGSVariable[vars.size() + dPkg.variables.length];
