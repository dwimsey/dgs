...
mkdir .background
cd .background
java -jar ..\..\..\mac\dgs4cl\dgs4cl.jar -d ..\..\..\DGSPreviewer\branding\DGSPreviewerDMGBackground.xml ..\..\..\DGSPreviewer\branding\DGSPreviewerDMGBackground.svg background.png
cd ..\..\..
