...
public class DGSPreviewerAboutBox extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(DGS.DGSPreviewer.DGSPreviewerApp.class).getContext().getResourceMap(DGSPreviewerAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(DGS.DGSPreviewer.DGSPreviewerApp.class).getContext().getActionMap(DGSPreviewerAboutBox.class, this);
