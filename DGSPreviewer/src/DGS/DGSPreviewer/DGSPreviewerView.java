...
import DGS.DGSPreviewer.DGSPrefsDialog;
...
public class DGSPreviewerView extends FrameView {
	...
	private DGS.DGSPreviewer.DGSPreviewCanvas.NotificationMethods notificationMethods = null;
...
//				break;
    ...
    private void initComponents() {
        ...
        previewCanvas = new DGS.DGSPreviewer.DGSPreviewCanvas();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(DGS.DGSPreviewer.DGSPreviewerApp.class).getContext().getResourceMap(DGSPreviewerView.class);
        fileMenu.setText(resourceMap.getString("fileMenu.text")); // NOI18N
        fileMenu.setName("fileMenu"); // NOI18N

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(DGS.DGSPreviewer.DGSPreviewerApp.class).getContext().getActionMap(DGSPreviewerView.class, this);
    ...
    private DGS.DGSPreviewer.DGSPreviewCanvas previewCanvas;
